...
import com.liferay.training.employee.exception.NoSuchloyeeException;
...
import com.liferay.training.employee.service.persistence.impl.constants.EmpPersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.training.employee.model.Employee"),
			true);
	}
