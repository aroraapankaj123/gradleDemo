...
public class EmployeeServiceHttp {
	...
	public static com.liferay.training.employee.model.Employee addEmployee(
			HttpPrincipal httpPrincipal, long groupId, String employeeName,
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, groupId, employeeName, employeeEmail,
				employeeDesignation, employeeAddress, serviceContext);
